...
STATIC_REQUIRED_FILES = {
    ...
    "engine/data/content/badges.json": '"id"',
    "engine/data/content/static-pages.json": '"sections"',
    "authlib/AuthlibSessionRepository.class.php": "userUuid",
    "api/content.php": "content_registry_not_found",
    "api/health.php": "HealthCheckService",
    "api/bootstrap/config.php": "FOXESCRAFT_BOOTSTRAP_STORAGE_DIRECTORY",
    "api/bootstrap/manifest.php": "resolveRuntimeForRequest",
    "api/bootstrap/runtime-catalog.php": "runtime-catalog/resolver.php",
    "api/bootstrap/runtime-catalog/request.php": "function parseRuntimeRequest",
    "api/bootstrap/runtime-catalog/platform.php": "function runtimeCatalogBranchesForPlatform",
    "api/bootstrap/runtime-catalog/filesystem.php": "function runtimeArchiveFiles",
    "api/bootstrap/runtime-catalog/metadata.php": "function runtimeInstallDirectoryName",
    "api/bootstrap/runtime-catalog/archive.php": "function inspectRuntimeArchive",
    "api/bootstrap/runtime-catalog/zip.php": "function inspectZipRuntime",
    "api/bootstrap/runtime-catalog/tar.php": "function inspectTarRuntime",
    "api/bootstrap/runtime-catalog/selection.php": "function evaluateRuntimeCompatibility",
    "api/bootstrap/runtime-catalog/resolver.php": "function resolveRuntimeForRequest",
