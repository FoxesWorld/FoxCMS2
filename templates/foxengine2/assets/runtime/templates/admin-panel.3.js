/* fox-runtime-template id=admin-panel sha256=9b4f223ea2e521b65d714f5023644618b67040a7557ae2c593c9f0126a0b2cb0 */
                          ...
                          : (_ctx.activeTab === 'settings')
                            ...
                            : (_ctx.activeTab === 'slides')
                              ? (_openBlock(), _createBlock(_component_AdminSlides, {
                                  ...
                                  onMove: _ctx.moveSlide,
                                  onUpload: _ctx.uploadSlideImage,
                                  onSave: _ctx.saveSlides
                                }, null, 8 /* PROPS */, ["settings", "routes", "loading", "onAdd", "onRemove", "onMove", "onUpload", "onSave"]))
                                    ...
                                    : (_ctx.activeTab === 'users')
                                      ...
                                      : (_ctx.activeTab === 'achievements')
                                        ? (_openBlock(), _createBlock(_component_AdminAchievements, {
                                          ...
                                          }, null, 8 /* PROPS */, ["available", "servers", "players", "server-id", "search", "loading", "onSelectServer", "onUpdate:search", "onSearch", "onReload", "onClearServer", "onClearPlayer"]))
...
export const sourceHash = "9b4f223ea2e521b65d714f5023644618b67040a7557ae2c593c9f0126a0b2cb0"
