...
<template>
  <article class="content-surface account-page">
    ...
    <form class="account-form" @submit.prevent="emit('submit')">
      <label><span>Логин</span><input v-model="form.login" name="login" type="text" autocomplete="username" required maxlength="64" placeholder="Ваш логин"></label>
      <label><span>Пароль</span><input v-model="form.password" name="password" type="password" autocomplete="current-password" required maxlength="4096" placeholder="Ваш пароль"></label>
      <UiCheckbox
