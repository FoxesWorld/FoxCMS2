...
{
    public static function runtimeCatalogBranchesForPlatform(string $platform): array
    {
        $branches = array(
            'windows-x86' => array(
    ...
    public static function runtimeCatalogScanRoots(string $runtimeRoot, string $platform): array
    {
        $roots = array();
        foreach (RuntimePlatform::runtimeCatalogBranchesForPlatform($platform) as $segments) {
            $path = $runtimeRoot;
    ...
    public static function platformFromJavaRelease(array $release): string
    {
