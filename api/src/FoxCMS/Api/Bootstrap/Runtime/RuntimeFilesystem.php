...
final class RuntimeFilesystem
{
    public static function runtimeArchiveFiles(string $scanRoot): array
    {
        $files = array();
        ...
        foreach ($iterator as $fileInfo) {
            ...
            if (RuntimeFilesystem::isRuntimeArchiveName($fileInfo->getFilename())) {
    ...
    public static function isRuntimeArchiveName(string $fileName): bool
    {
    ...
    public static function runtimeCatalogRelativePath(string $storageDirectory, string $absolutePath): string
    {
