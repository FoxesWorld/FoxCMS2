...
{
    public static function evaluateRuntimeCompatibility(array $candidate, array $request): array
    {
    ...
    public static function scoreRuntimeCandidate(array $candidate, array $request): int
    {
        $score = 1000;
    ...
    public static function preferredRuntimeCandidate(array $left, array $right): array
    {
    ...
    public static function summarizeRuntimeCandidate(array $candidate): array
    {
        return array(
    ...
    public static function buildRuntimeSelectionReason(array $selected, array $request): string
    {
        if (($request['version_mode'] ?? 'exact') === 'major') {
            return sprintf(
